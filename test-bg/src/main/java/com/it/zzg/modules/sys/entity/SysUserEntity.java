...
public class SysUserEntity implements Serializable {
	 ...
	 * 流程角色Code列表
	 */
	private List<String> flowRoleIdList;
	/**
	 * 流程角色name列表
	 */
	private List<String> flowRoleNameList;
	 ...
	 * 流程角色name列表
	 */
	public List<String> getFlowRoleNameList() {
		return flowRoleNameList;
	}

	public void setFlowRoleNameList(List<String> flowRoleNameList) {
		this.flowRoleNameList = flowRoleNameList;
	}
	 ...
	 * 流程角色Code列表
	 */
	public List<String> getFlowRoleIdList() {
		return flowRoleIdList;
	}

	public void setFlowRoleIdList(List<String> flowRoleIdList) {
		this.flowRoleIdList = flowRoleIdList;
	}
