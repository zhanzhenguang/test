...
public class AppBaseResult<T> implements Serializable {
	...
	public final static String KEY = "admin12345";
...
//				mData=data;
	...
	public String decryptData() {
		...
		if(!Tools.isEmpty(this.data)){
			try {
//				mData = CDESCrypt.decryptAsHexString(this.data, KEY);
...
//				this.data = CDESCrypt.encryptString(mData, KEY);
				...
				DesCrypt des = new DesCrypt();
				des.setKEY(KEY);
				this.data =  des.encode(java.net.URLEncoder.encode(java.net.URLEncoder.encode(mData,"utf-8"),"utf-8"));
//				this.data=mData;
			}else{
				this.data = mData;
			}
